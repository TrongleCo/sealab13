...
/datum/map/sealab/get_network_access(var/network)
	switch(network)
		if(NETWORK_AQUILA)
...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/sealab/substation/configure_and_install_coils()
...
/obj/machinery/power/smes/buildable/preset/sealab/substation_full/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil(src)
	component_parts += new /obj/item/weapon/smes_coil(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/obj/machinery/power/smes/buildable/preset/sealab/engine_main/configure_and_install_coils()
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/sealab/shuttle/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
	_input_on = TRUE
...
/obj/machinery/power/smes/buildable/preset/sealab/hangar/configure_and_install_coils()
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	component_parts += new /obj/item/weapon/smes_coil/super_io(src)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/datum/map/sealab/default_internal_channels()
	return list(
