...
/obj/structure/closet/secure_closet/administrator
	name = "administrator's locker"
...
/obj/structure/closet/secure_closet/administrator/WillContain()
	return list(
		/obj/item/device/radio/headset/heads/administrator,
