...
/datum/map/proc/is_species_branch_restricted(var/datum/species/S, var/datum/faction/MB)
...
/datum/map/proc/is_species_rank_restricted(var/datum/species/S, var/datum/faction/MB, var/datum/job_rank/MR)
